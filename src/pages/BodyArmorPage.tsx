  ...
  const products = [
    {
      ...
      price: 'From $899.99',
      imageUrl: '/images/0-650-shellback-tactical-banshee-elite-2-0-plate-carrier-gen-2-black.jpg',
    },
    {
      id: 'ba2',
      ...
      <main className="flex-grow">
        ...
        <div className="relative bg-tactical-dark text-white">
          <div 
            ...
            style={{ backgroundImage: "url('/images/.0-650-shellback-tactical-banshee-elite-2-0-plate-carrier-gen-2-black.jpg')" }}
          ></div>
